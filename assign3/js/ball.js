...
Ball.prototype.hittingTheTopAndBottomWalls = function(ball, HEIGHT){
	ball.checkForTheBottomWallHit(ball);
    ball.checkForThePadHit(ball);
    ball.checkIfBallLeftTheBox(ball);
}
...
Ball.prototype.checkForTheBottomWallHit = function(ball){
...
Ball.prototype.checkForThePadHit = function(ball){
    if(ball.y - ball.radius < paddle.paddleProperties.height
        &&
...
Ball.prototype.checkIfBallLeftTheBox = function(ball){
